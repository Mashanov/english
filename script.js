  ...
  switch (from)
  {
    ...
    case 2:
      ...
      for (var i = 0; i != a; i++)
      {
        ...
        let rgb_ball = array_color[Math.random () * array_color.length | 0];
        it('#container-ball').append(`<div class="ball" data-rgb="` + rgb_ball[0] + `" onclick="ball (this)" style="background: ` + rgb_ball[1] + `"></div>`);
      };
